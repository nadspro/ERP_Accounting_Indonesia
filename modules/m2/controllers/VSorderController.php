...
class VSorderController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['fSorder'])) {
            $model->attributes = $_POST['fSorder'];
    ...
    public function actionUpdate($id) {
        ...
        if ($model->approved_date != null) {
            ...
            //$this->redirect(array('/m2/vSorderInventory',));
        ...
        if (isset($_POST['vSorder'])) {
            $model->attributes = $_POST['vSorder'];
        ...
        if (!Yii::app()->request->isAjaxRequest) {
            ...
            $models = vSorderDetail::model()->findAll($criteria);
    ...
    public function loadModel($id) {
        $model = vSorder::model()->findByPk($id, 'po_type_id = 1');
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'vSorderInventory-form') {
