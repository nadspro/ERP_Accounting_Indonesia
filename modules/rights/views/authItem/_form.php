...
<?php
echo $form->textFieldRow($model, 'name', array('maxlength' => 255, 'class' => 'text-field',
    'hint' => Rights::t('core', 'Do not change the name unless you know what you are doing.')));
?>

<?php
echo $form->textFieldRow($model, 'description', array('maxlength' => 255, 'class' => 'text-field',
...
<?php if (Rights::module()->enableBizRule === true): ?>
    ...
    <?php
    echo $form->textFieldRow($model, 'bizRule', array('maxlength' => 255, 'class' => 'text-field',
