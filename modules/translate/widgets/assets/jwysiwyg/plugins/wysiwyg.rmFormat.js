...
(function($) {
    ...
    var rmFormat = {
        ...
        domTraversing: function(el, start, end, canRemove, cnt) {
            ...
            while (el) {
                if (this.debug) {
                    console.log(cnt, "canRemove=", canRemove);
                }
                ...
                if (el.firstElementChild) {
                    ...
                    if (this.debug) {
                        console.log(cnt, "domTraversing", el.firstElementChild);
                    }
                    ...
                    if (canRemove) {
                        ...
                        if (this.debug) {
                            console.log(cnt, el.nodeName, el.previousElementSibling, el.parentNode, p);
                        }
        ...
        run: function(Wysiwyg, options) {
            ...
            if (this.options.rules.heading || this.options.rules.table) {
                ...
                if (this.debug) {
                    console.log("DomTraversing=", traversing);
                }
            }
