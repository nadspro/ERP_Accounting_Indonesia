    ...
    <div class="form message-create">	
        ...
        <div class="mailbox-input-row">
            ...
            <div style="margin-left:80px">
                <?php echo $form->textField($conv, 'to', array('id' => 'message-to', 'class' => 'mailbox-input', 'style' => 'width:50%;', 'edit' => $this->module->editToField ? '1' : null)); ?>
        ...
        <div class="mailbox-input-row">
            ...
            <div class="mailbox-compose-inputwrap" style="margin-left:80px;">
                <?php echo $form->textField($conv, 'subject', array('class' => 'mailbox-input', 'style' => 'width:50%;', 'placeholder' => $this->module->defaultSubject)); ?>
