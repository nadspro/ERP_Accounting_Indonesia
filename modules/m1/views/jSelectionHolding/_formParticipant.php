...
Yii::app()->clientScript->registerScript('datepicker', "
		...
		$( \"#" . CHtml::activeId($model, 'applicant_name') . "\" ).autocomplete({
			'minLength' : 2,
			'source': ' " . Yii::app()->createUrl('/m1/jSelectionHolding/personAutoCompletePhoto') . "',
        ...
        . Yii::app()->baseUrl . "/shareimages/hr/applicant/" . "'+item.photo+'\'/><strong>'+item.label+'</strong><br/>'+item.company+'</a>')
			.appendTo( ul );
		};
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        echo $form->dropDownList($model, 'company_id', aOrganization::model()->companyDropDown(), array(
            ...
            'ajax' => array(
                'type' => 'POST',
                'url' => CController::createUrl('/m1/jSelectionHolding/deptUpdate'),
