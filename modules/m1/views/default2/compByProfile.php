            ...
            <div class="span6">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Age', 'data' => gPerson::compAgeAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span4">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Sex', 'data' => gPerson::compSexAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span5">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Religion', 'data' => gPerson::compReligionAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span5">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Education', 'data' => gPerson::compEducationAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
