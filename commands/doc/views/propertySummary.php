        ...
        <?php foreach ($class->properties as $property): ?>
            <?php if ($protected && $property->isProtected || !$protected && !$property->isProtected): ?>
                <tr<?php echo $property->isInherited ? ' class="inherited"' : ''; ?> id="<?php echo $property->name; ?>">
                    <td><?php echo $this->renderSubjectUrl($property->definedBy, $property->name, null, $property->sourcePathType); ?></td>
                    <td><?php echo $this->renderTypeUrl($property->type, $property->sourcePathType); ?></td>
                    <td><?php echo $property->introduction; ?></td>
                    <td><?php echo $this->renderTypeUrl($property->definedBy, $property->sourcePathType); ?></td>
                </tr>
            <?php endif; ?>
        <?php endforeach; ?>
    </table>
