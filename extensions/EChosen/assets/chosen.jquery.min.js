...
(function() {
    ...
    d = this, a = jQuery, a.fn.extend({chosen: function(c, d) {
        ...
        b.prototype.set_default_values = function() {
            ...
            this.container.click(e(function(a) {
                return this.container_click(a)
            ...
            }, this)), this.search_results.click(e(function(a) {
                return this.search_results_click(a)
        ...
        }, b.prototype.container_click = function(b) {
            b && b.type === "click" && b.stopPropagation();
            ...
            for (e = 0, f = g.length; e < f; e++)
                b = g[e], b.group ? a += this.result_add_group(b) : b.empty || (a += this.result_add_option(b), b.selected && this.is_multiple ? this.choice_build(b) : b.selected && !this.is_multiple && this.selected_item.find("span").text(b.text));
        ...
        }, b.prototype.search_results_click = function(b) {
            var c;
        ...
        }, b.prototype.result_select = function() {
            var a, b, c, d;
            if (this.result_highlight) {
                a = this.result_highlight, b = a.attr("id"), this.result_clear_highlight(), a.addClass("result-selected"), this.is_multiple ? this.result_deactivate(a) : this.result_single_selected = a, d = b.substr(b.lastIndexOf("_") + 1), c = this.results_data[d], c.selected = !0, this.form_field.options[c.options_index].selected = !0, this.is_multiple ? this.choice_build(c) : this.selected_item.find("span").first().text(c.text), this.results_hide(), this.search_field.val(""), this.form_field_jq.trigger("change");
                return this.search_field_scale()
            }
            ...
            for (d = 0, e = c.length; d < e; d++)
                b = c[d], b = a(b), f.push(b.hasClass("group-result") ? b.show() : !this.is_multiple || !b.hasClass("result-selected") ? this.result_activate(b) : void 0);
            return f
