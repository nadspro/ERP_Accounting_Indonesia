...
(function(e) {
    ...
    e.extend(e.fn.editableContainer.Constructor.prototype, {containerName: "popover", innerCss: e(e.fn.popover.defaults.template).find("p").length ? ".popover-content p" : ".popover-content", initContainer: function() {
            e.extend(this.containerOptions, {trigger: "manual", selector: !1, content: " "}), this.call(this.containerOptions)
        }, setContainerOption: function(e, t) {
