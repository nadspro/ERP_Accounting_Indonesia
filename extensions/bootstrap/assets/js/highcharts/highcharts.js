...
(function() {
    ...
    function Ob(a, b) {
        var c = b || [[vb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [hb, [1, 2, 5, 10, 15, 30]], [Ya, [1, 2, 5, 10, 15, 30]], [Ma, [1, 2, 3, 4, 6, 8, 12]], [oa, [1, 2]], [Za,
                [1, 2]], [Na, [1, 2, 3, 4, 6]], [ta, null]], d = c[c.length - 1], e = D[d[0]], f = d[1], g;
    ...
    if (!T && N.jQuery) {
        ...
        Q.extend(Q.easing, {easeOutQuad: function(a,
                    b, c, d, e) {
                return-d * (b /= e) * (b - 2) + c
            }});
    ...
    va.prototype = {init: function(a, b) {
                ...
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c](d, c), e !== !1) {
                        ...
                        if (c === "d")
                            ...
                            e = g.getElementsByTagName("title")[0], e || (e = B.createElementNS("http://www.w3.org/2000/svg",
            ...
            if (La && !Da)
                b && delete a.width, F(this.element,
                        a);
            else {
                for (c in a)
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if ($ !== this.cTT)
                        s(j) && (k = j * Eb, p = X(k), q = da(k), F(b, {filter: j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=",
    ...
    qa.prototype = {Element: va, init: function(a, b, c, d) {
        ...
        destroy: function() {
            ...
            for (var b = a.element, c = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                    "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = z(b, "x"), h = a.styles, i = h && w(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--; )
                b.removeChild(d[h]);
            ...
            var h =
                    this.label(a, b, c), i = 0, j, k, l, m, p, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = C(la("stroke-width", 1, "stroke", "#999", "fill", la("linearGradient", a, "stops", [[0, "#FFF"], [1, "#DDD"]]), "r", 3, "padding", 3, "style", la("color", "black")), e);
            l = e.style;
            delete e.style;
        ...
        arc: function(a, b, c, d, e, f) {
            ...
            if (g) {
                ...
                if (!c.id || !h[c.id])
                    Ja(c) && (a[g] = c = {x1: c[0], y1: c[1], x2: c[2], y2: c[3], gradientUnits: "userSpaceOnUse"}), g === "radialGradient" && b && !s(c.gradientUnits) && u(c, {cx: b[0] - b[2] /
                        ...
                        if (d = a[c], m = !1, e = p[c] && p[c](d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                ...
                                (f.getElementsByTagName("stroke")[0] ||
                                        S(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0;
                            else if (c === "fill")
    ...
    nb.prototype = {render: function() {
            ...
            if (h) {
                ...
                if (j = x(j, b.min - d), i = O(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {fill: r}, e.borderWidth)
                    d.stroke = e.borderColor, d["stroke-width"] =
                            e.borderWidth
            } else
                return;
            if (s(y))
            ...
            if (f && s(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                ...
                if (!g)
                    a.label = g = u.text(f.text, 0, 0).attr({align: f.textAlign || f.align, rotation: f.rotation,
    ...
    ob.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L",
        ...
        defaultBottomAxisOptions: {labels: {align: "center", x: 0, y: 14}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {align: "center", x: 0, y: -5}, title: {rotation: 0}}, init: function(a, b) {
            ...
            n(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        t = q.length;
                        for (f = 0; f < t; f++)
                            if (n = h[f], r = q[f], r !== null && r !== A && (i ? (J = (H = r < y) ? k : j, K = H ? p : l, r = J[n] = s(J[n]) ? J[n] + r : r, c[K] || (c[K] = {}), c[K][n] || (c[K][n] = new Cb(a, a.options.stackLabels, H, n,
                                    m)), c[K][n].setTotal(r)) : w && (r = g.modifyValue(r)), C || (h[f + 1] || n) >= Ha.min && (h[f - 1] || n) <= Ha.max))
                                if (n = r.length)
                                    for (; n--; )
                                        r[n] !== null && (u[v++] = r[n]);
                                else
            ...
            if (!i)
                i = f ? (b.getNonLinearTimeTicks || Pb)(Ob(b.tickInterval,
            ...
            if (p) {
                ...
                for (e = p.length; e--; )
                    if (i = a.series[e ? "yAxis" : "xAxis"], p[e] && i)
                        if (i =
                                i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[e])
    ...
    Db.prototype = {normalizeMouseEvent: function(a) {
            ...
            var h = function(a) {
                if (!a || !(a.touches && a.touches.length > 1)) {
                    ...
                    if (l)
                        d < c.plotLeft ? d = c.plotLeft : d > c.plotLeft + c.plotWidth && (d = c.plotLeft + c.plotWidth), h < c.plotTop ? h =
            ...
            if (b.enabled)
                a.tooltip = new pb(a, b), this.tooltipInterval =
    ...
    rb.prototype = {initSeries: function(a) {
            ...
            if (a.plotBorderWidth)
                g ? g.animate(g.crisp(null, this.plotLeft, this.plotTop, this.plotWidth, this.plotHeight)) : this.plotBorder = b.rect(this.plotLeft, this.plotTop, this.plotWidth, this.plotHeight,
        ...
        sorted: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, init: function(a, b) {
                ...
                for (f = b.length; f--; )
                    if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, e !== A && !isNaN(e))
                        if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(g.marker && g.marker.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                            k.animate(u({x: d - h,
                                y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else if (h > 0 || j)
            ...
            for (f = h.length; f--; ) {
                ...
                if (e) {
                    ...
                    e = c.hover = c.hover || {};
                    if (!a.options.marker)
                        e.color = pa(e.color || g.options.color).brighten(e.brightness ||
                                d.brightness).get();
    ...
    Y.area = G;
    Z.spline = C(T);
    ha = ca(R, {type: "spline", getPointSpline: function(a, b,
                c) {
    ...
    ha = ca(R, {type: "column", tooltipOutsidePlot: !0, pointAttrToOptions: {stroke: "borderColor",
            ...
            n(b.series, function(b) {
                if (b.type === a.type && b.visible && a.options.group === b.options.group)
                    b.options.stacking ? (j = b.stackKey, i[j] === A && (i[j] = f++),
            ...
            if (d.enabled) {
                ...
                for (a = q[0][0] && q[0][0].dataLabel && (q[0][0].dataLabel.getBBox().height || 21); x--; ) {
                    ...
                    for (v = 0; v < A; v++) {
                        ...
                        g.moved = !0;
                        if (p && f)
                            g = b.connector, h = i ? ["M", s + (h[6] === "left" ? 5 : -5), r, "C", s, r, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", s + (h[6] === "left" ? 5 : -5), r, "L", h[2], h[3], "L", h[4], h[5]], g ? (g.animate({d: h}), g.attr("visibility", t)) : b.connector = g = this.chart.renderer.path(h).attr({"stroke-width": f,
