...
(function(c) {
    c.widget("ui.dateRangeSliderHandle", c.ui.rangeSliderHandle, {_steps: !1, _boundsValues: {}, _create: function() {
            ...
            if (this.options.step === !1 || !this._isValidStep())
                ...
                for (this._steps = []; c <= b; )
                    this._steps.push(c.valueOf()), c = this._addStep(a, e, this.options.step), e++
            }
        },
        _isValidStep: function() {
            ...
            if (this._steps ===
                    !1)
                return a;
            for (var b = this.options.bounds.min.valueOf(), c = Math.floor(this._steps.length * Math.max(0, (a - b) / (this.options.bounds.max.valueOf() - b))); this._steps[c] > a; )
                c--;
            for (; c + 1 < this._steps.length && this._steps[c + 1] <= a; )
                c++;
            if (c >= this._steps.length - 1)
        ...
        add: function(a, b) {
            ...
            for (this.add(c, this.options.step) - c < 0 && (g = !0); c < e; )
                g ? e = this.add(e, this.options.step) : c = this.add(c, this.options.step), f++;
            return h ? -f : f
        }, multiplyStep: function(a, b) {
            var c = {}, e;
            for (e in a)
            ...
            return this.options.step ==
                    !1 ? 1 : this.cache.parent.width / this._steps.length
        }})
})(jQuery);
(function(c) {
    c.widget("ui.dateRangeSlider", c.ui.rangeSlider, {options: {bounds: {min: new Date(2010, 0, 1), max: new Date(2012, 0, 1)}, defaultValues: {min: new Date(2010, 1, 11), max: new Date(2011, 1, 11)}}, _create: function() {
            ...
            (a === "defaultValues" || a === "bounds") && typeof b !== "undefined" &&
                    b !== null && typeof b.min !== "undefined" && typeof b.max !== "undefined" && b.min instanceof Date && b.max instanceof Date ? c.ui.rangeSlider.prototype._setOption.apply(this, [a, {min: b.min.valueOf(), max: b.max.valueOf()}]) : c.ui.rangeSlider.prototype._setOption.apply(this, this._toArray(arguments))
        }, _handleType: function() {
            ...
            if (typeof a !== "undefined" && a instanceof Date)
                return new Date(c.ui.rangeSlider.prototype.min.apply(this, [a.valueOf()]));
            return new Date(c.ui.rangeSlider.prototype.min.apply(this))
        }, max: function(a) {
            if (typeof a !== "undefined" && a instanceof Date)
                return new Date(c.ui.rangeSlider.prototype.max.apply(this, [a.valueOf()]));
