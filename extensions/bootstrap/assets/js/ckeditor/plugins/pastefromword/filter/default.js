        ...
        (function() {
            ...
            w.removeAnyChildWithName =
                    function(a) {
                        for (var b = this.children, d = [], c, e = 0; e < b.length; e++)
                            c = b[e], c.name && (c.name == a && (d.push(c), b.splice(e--, 1)), d = d.concat(c.removeAnyChildWithName(a)));
                        return d
                    };
            ...
            C.firstChild = w.firstChild = function(a) {
                for (var b, d = 0; d < this.children.length; d++)
                    if (b = this.children[d], a(b) || b.name && (b = b.firstChild(a)))
                        return b;
                return null
            };
            ...
            var G = /^([.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz){1}?/i, D = /^(?:\b0[^\s]*\s*){1,4}$/, x = {ol: {decimal: /\d+/, "lower-roman": /^m{0,4}(cm|cd|d?c{0,3})(xc|xl|l?x{0,3})(ix|iv|v?i{0,3})$/,
                    "upper-roman": /^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/, "lower-alpha": /^[a-z]+$/, "upper-alpha": /^[A-Z]+$/}, ul: {disc: /[l\u00B7\u2002]/, circle: /[\u006F\u00D8]/, square: /[\u006E\u25C6]/}}, z = [[1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [50, "L"], [40, "XL"], [10, "X"], [9, "IX"], [5, "V"], [4, "IV"], [1, "I"]], B = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", u = 0, p = null, v, E = CKEDITOR.plugins.pastefromword = {utils: {createListBulletMarker: function(a, b) {
                        ...
                        if ((d = a.removeAnyChildWithName("cke:listbullet")) && d.length && (d = d[0]))
                            return a.name = "cke:li", b.style && (b.style = E.filters.stylesFilter([["text-indent"], ["line-height"],
                        ...
                        for (var b = a.children, d, c, e, f, h, g, a = [], i, n, j, m, k, r, q = 0; q < b.length; q++)
                            if (d = b[q], "cke:li" == d.name)
                                if (d.name = "li", c = d.attributes, j = (j = c["cke:listsymbol"]) && j.match(/^(?:[(]?)([^\s]+?)([.)]?)$/), m = k = r = null, c["cke:ignored"])
                                    b.splice(q--, 1);
                                else {
                        ...
                        for (q = 0; q < a.length; q++)
                            if (g = a[q], s = g.children, i = i = void 0, t = g.children.length, o = i = void 0, b = /list-style-type:(.*?)(?:;|$)/, f = CKEDITOR.plugins.pastefromword.filters.stylesFilter, i = g.attributes, !b.exec(i.style)) {
                                for (h = 0; h <
                                        t; h++)
                        ...
                        return function(d, c) {
                            ...
                            (d || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(d, g, f) {
                                ...
                                for (var n, j, m, k = 0; k < a.length; k++)
                                    if (a[k] && (d = a[k][0], n = a[k][1], j = a[k][2], m = a[k][3], g.match(d) && (!n || f.match(n)))) {
                                        g = m || g;
                                        b && (j = j || f);
                    ...
                    return{elementNames: [[/meta|link|script/, ""]], root: function(a) {
                            ...
                            j(a)
                                ...
                                l in d && e.style && (e.style = f([[/^(:?width|height)$/, null, q]])(e.style) || "");
                                if (l.match(/h\d/)) {
                                    a.filterChildren();
                                    if (r(a))
                                        return;
                                    h(c["format_" + l])(a)
                                } else if (l in b.$inline)
                                    a.filterChildren(), k(a) && delete a.name;
                                else if (-1 != l.indexOf(":") && -1 == l.indexOf("cke")) {
                                    a.filterChildren();
                                    if ("v:imagedata" ==
                                            l) {
                                        if (l = a.attributes["o:href"])
                                            a.attributes.src = l;
                                        a.name = "img";
                                        return
                                    }
                                ...
                                if (CKEDITOR.env.gecko) {
                                    ...
                                    a && (a.replace(/[\n\r]/g, "").replace(/(.+?)\{(.+?)\}/g, function(a, b, d) {
                                        for (var b = b.split(","), a = b.length, c = 0; c < a; c++)
                                            CKEDITOR.tools.trim(b[c]).replace(/^(\w+)(\.[\w-]+)?$/g, function(a, b, c) {
                                                b = b || "*";
                                ...
                                if (m(a)) {
                                    ...
                                    if (d)
                                        return b = i(d, b), (a = a.getAncestor("span")) && / mso-hide:\s*all|display:\s*none /.test(a.attributes.style) && (b.attributes["cke:ignored"] = 1), b
                                }
                                if (d = (b = a.attributes) && b.style)
                                    b.style = f([["line-height"], [/^font-family$/, null, !o ? g(c.font_style, "family") : null], [/^font-size$/, null, !o ? g(c.fontSize_style, "size") : null], [/^color$/, null, !o ? g(c.colorButton_foreStyle, "color") : null], [/^background-color$/, null, !o ? g(c.colorButton_backStyle, "color") :
                                                    null]])(d, a) || "";
                                return null
                                ...
                                ""], [/^onload$/, ""], [/(?:v|o):\w+/, ""], [/^lang/, ""]], attributes: {style: f(p ? [[/^list-style-type$/, null], [/^margin$|^margin-(?!bottom|top)/, null, function(a, b, d) {
                                    ...
                                    }], [/^margin$/, D], ["text-indent", "0cm"], ["page-break-before"], ["tab-stops"], ["display", "none"], o ? [/font-?/] : null], p), width: function(a, c) {
