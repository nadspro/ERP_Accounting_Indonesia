 ...
 */
    ...
    function n(j, i) {
        ...
        for (var a = b, c, g = [], d = 0; d < h.length; d++)
            c = h[d], b = a / h[d], 1 < b && 2 >= b && (a -= c, g.push(e[c]));
    ...
    return{title: j.title, minWidth: 600, minHeight: 400, contents: [{id: "info", label: f.lang.common.generalTab, expand: !0, elements: [{type: "html", id: "legends", style: "white-space:normal;", focus: function() {
                        }, html: function() {
                            for (var e =
