        ...
        (function() {
            ...
            function o(a, f) {
                ...
                return{title: a.lang.table.title, minWidth: 310, minHeight: CKEDITOR.env.ie ? 310 : 280,
                        ...
                        if (b.info) {
                            ...
                            if (!c.$.tHead && ("row" == f || "both" == f)) {
                                ...
                                for (i = 0; i < g.getChildCount(); i++)
                                    h = g.getChild(i), h.type == CKEDITOR.NODE_ELEMENT &&
                                            !h.data("cke-bookmark") && (h.renameNode("th"), h.setAttribute("scope", "col"));
                                j.append(g.remove())
                            }
                            if (null !== c.$.tHead && !("row" == f || "both" == f)) {
                                ...
                                for (k = g.getFirst(); 0 < j.getChildCount(); ) {
                                    g = j.getFirst();
                                    for (i = 0; i < g.getChildCount(); i++)
                                        h = g.getChild(i), h.type == CKEDITOR.NODE_ELEMENT && (h.renameNode("td"), h.removeAttribute("scope"));
                                    g.insertBefore(k)
                                }
                                j.remove()
                            }
                            ...
                            if (this.hasColumnHeaders && !("col" == f || "both" == f))
                                for (i = 0; i < c.$.rows.length; i++)
                                    j = new CKEDITOR.dom.element(c.$.rows[i]), "tbody" == j.getParent().getName() && (h = new CKEDITOR.dom.element(j.$.cells[0]), h.renameNode("td"), h.removeAttribute("scope"));
                        ...
                        if (this._.selectedElement)
                            ...
                            a.insertElement(c),
                                ...
                                b.select()
                    ...
                    }, contents: [{id: "info", label: a.lang.table.title, elements: [{type: "hbox", widths: [null, null], styles: ["vertical-align:top"], children: [{type: "vbox", padding: 0, children: [{type: "text", id: "txtRows", "default": 3, label: a.lang.table.rows, required: !0, controlStyle: "width:5em", validate: n(a.lang.table.invalidRows), setup: function(d) {
                                                        this.setValue(d.$.rows.length)
                                                    },
                                                    commit: m}, {type: "text", id: "txtCols", "default": 2, label: a.lang.table.columns, required: !0, controlStyle: "width:5em", validate: n(a.lang.table.invalidCols), setup: function(d) {
                                                        this.setValue(r(d))
                                                    }, commit: m}, {type: "html", html: "&nbsp;"}, {type: "select", id: "selHeaders", "default": "", label: a.lang.table.headers, items: [[a.lang.table.headersNone, ""], [a.lang.table.headersRow, "row"], [a.lang.table.headersColumn, "col"], [a.lang.table.headersBoth, "both"]], setup: function(d) {
                                                    ...
                                                    }, commit: m}, {type: "text", id: "txtBorder", "default": 1, label: a.lang.table.border, controlStyle: "width:3em", validate: CKEDITOR.dialog.validate.number(a.lang.table.invalidBorder), setup: function(d) {
                                                        ...
                                                        this.getValue() ? e.setAttribute("align", this.getValue()) : e.removeAttribute("align")
                                                            ...
                                                            }, commit: m}]}, {type: "hbox", widths: ["5em"], children: [{type: "text", id: "txtHeight",
                                                            ...
                                                            }, commit: m}]}, {type: "html", html: "&nbsp;"}, {type: "text", id: "txtCellSpace", controlStyle: "width:3em",
                                                ...
                                                if (this.isEnabled()) {
                                                    ...
                                                    if (c)
                                                        0 < b.count() ? (b = b.getItem(0), b.setHtml("")) : (b = new CKEDITOR.dom.element("caption", a.document), e.getChildCount() ? b.insertBefore(e.getFirst()) : b.appendTo(e)), b.append(new CKEDITOR.dom.text(c, a.document));
                                                    else if (0 < b.count())
