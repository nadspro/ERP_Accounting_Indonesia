    ...
    function n(a, k) {
        ...
        return{title: a.lang.div.title, minWidth: 400, minHeight: 165, contents: [{id: "info", label: a.lang.common.generalTab, title: a.lang.common.generalTab, elements: [{type: "hbox", widths: ["50%", "50%"], children: [{id: "elementStyle", type: "select", style: "width: 100%;", label: a.lang.div.styleSelectLabel, "default": "", items: [[a.lang.common.notSet, ""]], onChange: function() {
                                        ...
                                        for (var d = [].concat(d), c = d.length, i, e = 0; e < c; e++)
                                            (i = b.getContentElement.apply(b, d[e].split(":"))) && i.setup && i.setup(h, !0)
                                    }, setup: function(a) {
                                        for (var b in l)
                                ...
                                {id: "class", type: "text", label: a.lang.common.cssClass, "default": ""}]}]}, {id: "advanced", label: a.lang.common.advancedTab, title: a.lang.common.advancedTab, elements: [{type: "vbox", padding: 1, children: [{type: "hbox", widths: ["50%", "50%"], children: [{type: "text", id: "id", label: a.lang.common.id, "default": ""}, {type: "text", id: "lang", label: a.lang.common.langCode, "default": ""}]}, {type: "hbox", children: [{type: "text", id: "style", style: "width: 100%;", label: a.lang.common.cssStyle, "default": "", commit: function(a) {
                                                var b = this.getValue() +
                                                        (a.getCustomData("elementStyle") || "");
                                                a.setAttribute("style", b)
                                            }}]}, {type: "hbox", children: [{type: "text", id: "title", style: "width: 100%;", label: a.lang.common.advisoryTitle, "default": ""}]}, {type: "select", id: "dir", style: "width: 100%;", label: a.lang.common.langDir, "default": "", items: [[a.lang.common.notSet, ""], [a.lang.common.langDirLtr, "ltr"], [a.lang.common.langDirRtl, "rtl"]]}]}]}], onLoad: function() {
                o.call(this);
                ...
                if ("editdiv" == k)
                    ...
                    for (j = 0; j < h.length; j++)
                        c = h[j], f = a.elementPath(c).blockLimit, a.config.div_wrapTable && f.is(["td", "th"]) && (f = a.elementPath(f.getParent()).blockLimit), f.equals(g) || (g = f, e.push([])), e[e.length - 1].push(c);
                    for (g = 0; g < e.length; g++) {
                        f = e[g][0];
                        h = f.getParent();
