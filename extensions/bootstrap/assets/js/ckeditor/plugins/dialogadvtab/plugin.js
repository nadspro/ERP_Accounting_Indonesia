        ...
        (function() {
            ...
            CKEDITOR.plugins.add("dialogadvtab", {createAdvancedTab: function(c, b) {
                    ...
                    var a = c.lang.common, g = {id: "advanced", label: a.advancedTab, title: a.advancedTab,
                        elements: [{type: "vbox", padding: 1, children: []}]}, d = [];
                    if (b.id || b.dir)
                        b.id && d.push({id: "advId", att: "id", type: "text", label: a.id, setup: e, commit: f}), b.dir && d.push({id: "advLangDir", att: "dir", type: "select", label: a.langDir, "default": "", style: "width:100%", items: [[a.notSet, ""], [a.langDirLTR, "ltr"], [a.langDirRTL, "rtl"]], setup: e, commit: f}), g.elements[0].children.push({type: "hbox", widths: ["50%", "50%"], children: [].concat(d)});
                    if (b.styles || b.classes)
                        d = [], b.styles && d.push({id: "advStyles", att: "style", type: "text",
                            label: a.styles, "default": "", validate: CKEDITOR.dialog.validate.inlineStyle(a.invalidInlineStyle), onChange: function() {
                                ...
                                "55%"], children: [{id: "advCSSClasses", att: "class", type: "text", label: a.cssClasses, "default": "", setup: e, commit: f}]}), g.elements[0].children.push({type: "hbox", widths: ["50%", "50%"], children: [].concat(d)});
                    return g
                }})
        })();