...
YAHOO.namespace = function() {
    ...
    for (b = 0; b < c.length; b += 1) {
        a = ("" + c[b]).split(".");
        e = YAHOO;
        for (d = "YAHOO" == a[0]?1:0; d < a.length; d += 1)
            e[a[d]] = e[a[d]] || {}, e = e[a[d]]
    }
    return e
};
...
YAHOO.env.ua = function() {
    ...
    if ((b = e.match(/AppleWebKit\/([^\s]*)/)) && b[1]) {
        ...
        if (/ Mobile\//.test(e))
            c.mobile = "Apple";
        else if (b = e.match(/NokiaN[^\/]*/))
            c.mobile = b[0];
        if (b = e.match(/AdobeAIR\/([^\s]*)/))
            c.air = b[0]
    }
    if (!c.webkit)
        if ((b = e.match(/Opera[\s\/]([^\s]*)/)) && b[1]) {
            if (c.opera = parseFloat(b[1]), b = e.match(/Opera Mini[^;]*/))
                c.mobile = b[0]
        } else if ((b = e.match(/MSIE\s([^;]*)/)) &&
                b[1])
            c.ie = parseFloat(b[1]);
        else if (b = e.match(/Gecko\/([^\s]*)/))
            if (c.gecko = 1, (b = e.match(/rv:([^\s\)]*)/)) && b[1])
                c.gecko = parseFloat(b[1]);
    if ((b = e.match(/Caja\/([^\s]*)/)) && b[1])
        c.caja = parseFloat(b[1]);
    return c
}();
(function() {
...
(function() {
    var c = YAHOO.lang, e = Object.prototype, b = ["toString", "valueOf"], d = {isArray: function(a) {
            ...
            for (g = 0; g < b.length; g += 1)
                h = b[g], i = d[h], c.isFunction(i) && i != e[h] && (a[h] = i)
        } : function() {
            ...
            if (d) {
                for (i in d)
                    c.hasOwnProperty(d, i) && (a.prototype[i] = d[i]);
            ...
            for (e = 2; e < arguments.length; e += 1)
                d.push(arguments[e]);
            ...
            if (c.isObject(a)) {
                if (a instanceof
                        Date || "nodeType"in a && "tagName"in a)
                    return a;
                if (c.isFunction(a))
                    return"f(){...}"
            } else
            ...
            if (c.isArray(a)) {
                ...
                for (e = a.length; d < e; d += 1)
                    c.isObject(a[d]) ? i.push(0 < b ? c.dump(a[d], b - 1) : "{...}") : i.push(a[d]), i.push(", ");
                1 < i.length && i.pop();
                i.push("]")
            } else {
                i.push("{");
                for (d in a)
                    c.hasOwnProperty(a, d) && (i.push(d + " => "), c.isObject(a[d]) ? i.push(0 < b ? c.dump(a[d], b - 1) : "{...}") : i.push(a[d]), i.push(", "));
                1 < i.length && i.pop();
                i.push("}")
            }
            return i.join("")
            ...
            for (h = m.length - 1; 0 <= h; h -= 1)
                a = a.replace(RegExp("~-" + h + "-~"), "{" + m[h] + "}", "g");
            return a
        }, trim: function(a) {
            try {
...
(function() {
    ...
    c.Dom = {CUSTOM_ATTRIBUTES: !j.hasAttribute ? {"for": "htmlFor", "class": "className"} : {htmlFor: "for", className: "class"}, get: function(a) {
            ...
            if (window.getComputedStyle)
                return a.ownerDocument.defaultView.getComputedStyle(a, null)[b];
            if (a.currentStyle)
                return c.Dom.IE_ComputedStyle.get(a, b)
            ...
            return n ? function(a, b) {
                ...
                if (a)
                    switch (d) {
                        case "opacity":
                            if (e.isString(a.style.filter) && (a.style.filter = "alpha(opacity=" + 100 * f + ")", !a.currentStyle || !a.currentStyle.hasLayout))
                                a.style.zoom = 1;
                            break;
                        case "float":
                            d = "styleFloat";
            ...
            return i.documentElement.getBoundingClientRect ? function(a) {
                ...
                if (c.Dom._canPosition(a)) {
                    ...
                    for (e = m || 519 < b.webkit?!0:!1; j = j.offsetParent; )
                        g[0] += j.offsetLeft, g[1] += j.offsetTop, e && (g = c.Dom._calcBorders(j, g));
                    if ("fixed" !== c.Dom._getStyle(a, "position")) {
                        for (j = a; (j = j.parentNode) && j.tagName; )
                            if (a =
                                    j.scrollTop, e = j.scrollLeft, m && "visible" !== c.Dom._getStyle(j, "overflow") && (g = c.Dom._calcBorders(j, g)), a || e)
                                g[0] -= e, g[1] -= a;
                        g[0] += d;
                        g[1] += f
                    } else if (k)
            ...
            if (!d)
                return[];
            for (var h =
                    [], b = d.getElementsByTagName(b), d = c.Dom.hasClass, m = 0, k = b.length; m < k; ++m)
                d(b[m], a) && (h[h.length] = b[m]);
            ...
            var b = b || "yui-gen", d = function(a) {
                ...
                if (a) {
                    if (a.ownerDocument.getElementById(d))
                        return c.Dom.generateId(a, d + b);
                    a.id = d
                }
                return d
            };
            ...
            if (!d)
                return[];
            for (var h = [], b = d.getElementsByTagName(b), d = 0, m = b.length; d < m; ++d)
                if (a(b[d]))
                    if (j) {
                        h = b[d];
                        break
            ...
            if ((b || n) && !k)
                a = "CSS1Compat" == b ? j.clientHeight : i.body.clientHeight;
            return a
        }, getViewportWidth: function() {
            var a = self.innerWidth,
                    b = i.compatMode;
            if (b || n)
                a = "CSS1Compat" == b ? j.clientWidth : i.body.clientWidth;
            return a
        }, getAncestorBy: function(a, b) {
            for (; a = a.parentNode; )
                if (c.Dom._testElement(a, b))
                    return a;
            return null
        ...
        }, getPreviousSiblingBy: function(a,
                b) {
            for (; a; )
                if (a = a.previousSibling, c.Dom._testElement(a, b))
                    return a;
            return null
            ...
            for (; a; )
                if (a = a.nextSibling, c.Dom._testElement(a, b))
                    return a;
            return null
...
(function() {
    var c = YAHOO.util, e = /^width|height$/, b = /^(\d[.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz|%){1}?/i, d = {get: function(a, d) {
            ...
            for (var d; (d = a.currentStyle) && "inherit" == d[b]; )
                a = a.parentNode;
...
(function() {
    ...
    b.Dom.Color = {KEYWORDS: {black: "000", silver: "c0c0c0", gray: "808080", white: "fff", maroon: "800000", red: "f00", purple: "800080", fuchsia: "f0f", green: "008000", lime: "0f0", olive: "808000", yellow: "ff0", navy: "000080", blue: "00f", teal: "008080", aqua: "0ff"}, re_RGB: /^rgb\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\)$/i, re_hex: /^#?([0-9A-F]{2})([0-9A-F]{2})([0-9A-F]{2})$/i, re_hex3: /([0-9A-F])/gi, toRGB: function(d) {
            ...
            if (b.Dom.Color.re_RGB.exec(d))
                var d = 1 === e.$2.length ? "0" + e.$2 : Number(e.$2), a = 1 === e.$3.length ? "0" + e.$3 : Number(e.$3), d = [(1 === e.$1.length ? "0" + e.$1 : Number(e.$1)).toString(16), d.toString(16), a.toString(16)].join("");
...
YAHOO.util.Event || (YAHOO.util.Event = function() {
    ...
    return{POLL_RETRYS: 2E3, POLL_INTERVAL: 20, EL: 0, TYPE: 1, FN: 2, WFN: 3, UNLOAD_OBJ: 3, ADJ_SCOPE: 4, OBJ: 5, OVERRIDE: 6, lastError: null, isSafari: YAHOO.env.ua.webkit, webkit: YAHOO.env.ua.webkit, isIE: YAHOO.env.ua.ie, _interval: null, _dri: null, DOMReady: !1, throwErrors: !1, startInterval: function() {
            ...
            for (var a = YAHOO.lang.isString(a) ? [a] : a, j = 0; j < a.length; j += 1)
                g.push({id: a[j], fn: b, obj: d, overrideContext: c, checkReady: e});
            f = this.POLL_RETRYS;
            this.startInterval()
        ...
        _addListener: function(c, f, g, j, k, i) {
            ...
            if (this._isValidCollection(c)) {
                for (var i = !0, l = 0, s = c.length; l < s; ++l)
                    i = this.on(c[l], f, g, j, k) && i;
                return i
            }
            if (YAHOO.lang.isString(c))
                if (l = this.getEl(c))
                    ...
                    return this.onAvailable(c, function() {
                        YAHOO.util.Event.on(c, f, g, j, k)
                    }), !0;
            if (!c)
                return!1;
            if ("unload" == f && j !== this)
                return b[b.length] = [c, f, g, j, k], !0;
            var t = c;
            k && (t = !0 === k ? j : k);
            l = function(a) {
            ...
            if (this.useLegacyEvent(c,
                ...
                if (-1 == p || c != d[p][0])
                    p = d.length, h[c.id + f] = p, d[p] = [c, f, c["on" + f]], a[p] = [], c["on" + f] = function(a) {
            ...
            for (var h = 0, k = e.length; h < k; ++h)
                if ((g = e[h]) && g[this.WFN])
                    j = g[this.ADJ_SCOPE], g = g[this.WFN].call(j, b), f = f && g;
            if ((e = d[c]) && e[2])
                e[2](b);
            return f
            ...
            if ("string" == typeof d)
                ...
                for (j = d.length - 1; - 1 < j; j--)
                    g = this.removeListener(d[j], c, f) && g;
                return g
            }
            if (!f || !f.call)
                return this.purgeElement(d, !1, c);
            if ("unload" == c) {
                for (j = b.length - 1; - 1 < j; j--)
                    if ((k = b[j]) && k[0] == d && k[1] == c && k[2] == f)
                        return b.splice(j, 1), !0;
                return!1
            }
            j = null;
            ...
            if (this.useLegacyEvent(d,
                ...
                if (i) {
                    j = 0;
                    for (h = i.length; j < h; ++j)
                        if ((k = i[j]) && k[this.EL] == d && k[this.TYPE] == c && k[this.FN] == f) {
                            i.splice(j, 1);
                            break
                        }
                }
            ...
            return a
        }, _getCacheIndex: function(a,
                b, d) {
            for (var c = 0, f = e.length; c < f; c += 1) {
                var g = e[c];
                if (g && g[this.FN] == d && g[this.EL] == a && g[this.TYPE] == b)
                    return c
            }
            return-1
            ...
            if (0 === g.length)
                f = 0, this._interval && (clearInterval(this._interval), this._interval = null);
            else if (!this.locked)
                if (this.isIE && !this.DOMReady)
                    ...
                    e = 0;
                    for (j = g.length; e < j; e += 1)
                        if (h = g[e])
                            if (k = this.getEl(h.id))
                                if (h.checkReady) {
                                    if (c || k.nextSibling || !a)
                                        i.push(h), g[e] = null
                                } else
                                    d(k, h), g[e] = null;
                            else
                                b.push(h);
                    e = 0;
                    for (j = i.length; e < j; e += 1)
                        h = i[e], d(this.getEl(h.id), h);
                    f--;
                    if (a) {
                        for (e = g.length - 1; - 1 < e; e--)
                            h = g[e], (!h || !h.id) && g.splice(e, 1);
                        this.startInterval()
                    } else
            ...
            if (b && a && a.childNodes) {
                f = 0;
                for (c = a.childNodes.length; f < c; ++f)
                    this.purgeElement(a.childNodes[f], b, d)
            }
            ...
            for (j = b.length; f < j; ++f)
                if (g = h[f])
                    k = window, g[c.ADJ_SCOPE] && (k = !0 === g[c.ADJ_SCOPE] ? g[c.UNLOAD_OBJ] : g[c.ADJ_SCOPE]), g[c.FN].call(k, c.getEvent(a, g[c.EL]), g[c.UNLOAD_OBJ]), h[f] = null;
            b = null;
            if (e)
                for (a = e.length - 1; - 1 < a; a--)
                    (g = e[a]) && c.removeListener(g[c.EL], g[c.TYPE], g[c.FN],
                            a);
            d = null;
    ...
    if (c.isIE) {
        ...
        c.webkit && 525 > c.webkit ? c._dri = setInterval(function() {
...
YAHOO.util.EventProvider.prototype = {__yui_events: null, __yui_subscribers: null, subscribe: function(c, e, b, d) {
        ...
        if (c) {
            if (d = d[c])
                return d.unsubscribe(e, b)
        } else {
            var c = true, a;
            for (a in d)
                YAHOO.lang.hasOwnProperty(d, a) && (c = c && d[a].unsubscribe(e,
                        b));
            return c
        }
        return false
        ...
        if (!d[c]) {
            ...
            if (b = this.__yui_subscribers[c])
                for (var f = 0; f < b.length; ++f)
                    a.subscribe(b[f].fn, b[f].obj, b[f].overrideContext)
        }
        return d[c]
    },
...
YAHOO.util.DragDropMgr || (YAHOO.util.DragDropMgr = function() {
    ...
    return{useShim: false, _shimActive: false, _shimState: false, _debugShim: false, _createShim: function() {
        ...
        getRelated: function(b, d) {
            ...
            for (c in b.groups)
                for (var e in this.ids[c]) {
                    var h = this.ids[c][e];
                    if (this.isTypeOfDD(h) && (!d || h.isTarget))
                        a[a.length] = h
                }
            return a
        }, isLegalTarget: function(b, d) {
            for (var a = this.getRelated(b, true), c = 0, e = a.length; c < e; ++c)
                if (a[c].id == d.id)
                    return true;
            return false
        ...
        handleMouseDown: function(b, d) {
            ...
            if (a == 1)
                ...
                for (var c = 0; c < a; ++c) {
                    ...
                    if (this.mode ==
                        ...
                        d = e;
                        break
                    } else if (!d || !d.overlap || e.overlap && d.overlap.getArea() < e.overlap.getArea())
                        d = e
                }
            return d
            ...
            if (!h || !a && !h.constrainX && !h.constrainY)
            ...
            if (!d || !d.el)
                d = this.elementCache[b] = new this.ElementWrapper(YAHOO.util.Dom.get(b));
            return d
        },
        ...
        getClientWidth: function() {
            ...
            if (YAHOO.util.Event && document)
                b._onLoad();
            else if (!(b._timeoutCount > 2E3)) {
                setTimeout(b._addListeners, 10);
                if (document && document.body)
                    b._timeoutCount = b._timeoutCount + 1
            }
    ...
    YAHOO.util.DragDrop.prototype = {events: null, on: function() {
        ...
        onInvalidDrop: function() {
            ...
            if (this.config.events)
                for (var b in this.config.events)
                    this.config.events[b] === false && (this.events[b] = false);
        ...
        removeInvalidHandleType: function(b) {
            ...
            for (var d = 0, a = this.invalidHandleClasses.length; d < a; ++d)
                this.invalidHandleClasses[d] == b && delete this.invalidHandleClasses[d]
            ...
            a = 0;
            for (var g = this.invalidHandleClasses.length; d && a < g; ++a)
                d = !e.hasClass(b, this.invalidHandleClasses[a]);
            return d
        }, setXTicks: function(b, d) {
            this.xTicks = [];
            this.xTickSize = d;
            for (var a = {}, c = this.initPageX; c >= this.minX; c = c - d)
                if (!a[c]) {
                    this.xTicks[this.xTicks.length] = c;
                    a[c] = true
                }
            for (c = this.initPageX; c <= this.maxX; c = c + d)
                if (!a[c]) {
                    this.xTicks[this.xTicks.length] = c;
                    a[c] = true
                }
            ...
            for (c = this.initPageY; c <= this.maxY; c = c + d)
                if (!a[c]) {
                    this.yTicks[this.yTicks.length] = c;
                    a[c] = true
                }
...
(function() {
    ...
    YAHOO.extend(c, YAHOO.util.DragDrop, {_mouseDown: false, dragOnly: true, initSlider: function(a) {
            ...
            else if (a.yTicks && a.yTicks.length)
            ...
            if (this.isLocked() && !e || isNaN(b) || j._isRegion)
                return false;
            this._silent = i;
            ...
            if (this.isLocked() && !i || isNaN(b) || !k._isRegion)
                return false;
            this._silent = j;
            this.valueChangeSource = a || c.SOURCE_SET_VALUE;
            k.lastOffset = [b, d];
...
(function() {
    ...
    c.prototype = {minVal: -1, maxVal: -1, minRange: 0, _handleSlideStart: function(b, a) {
            ...
            if (b.__yui_events && b.events[a]) {
                for (e = b.__yui_events.length; e >= 0; --e)
                    if (b.__yui_events[e].type === a) {
                        c = b.__yui_events[e];
                        break
                    }
                if (c) {
    ...
    b.Slider.getVertDualSlider = function(c,
            a, e, g, h, i) {
...
YAHOO.util.Attribute.prototype = {name: void 0, value: null, owner: null, readOnly: !1, writeOnce: !1, _initialConfig: null, _written: !1, method: null, setter: null, getter: null, validator: null, getValue: function() {
        ...
        if (this.readOnly || this.writeOnce && this._written || this.validator && !this.validator.call(d, c))
            return false;
        if (!e) {
...
(function() {
    ...
    YAHOO.util.AttributeProvider.prototype = {_configs: null, get: function(c) {
            ...
            for (b in this._configs)
                c.hasOwnProperty(this._configs, b) && !c.isUndefined(this._configs[b]) &&
                        (e[e.length] = b);
            return e
        }, setAttributes: function(e, b) {
            for (var d in e)
                c.hasOwnProperty(e, d) && this.set(d, e[d], b)
            ...
            for (var d = this._configs = this._configs || {}, e = (c.isString(e) ? [e] : e) || this.getAttributeKeys(), a = 0, f = e.length; a < f; ++a)
                d.hasOwnProperty(e[a]) && this._configs[e[a]].refresh(b)
            ...
            for (e in b)
                c.hasOwnProperty(b, e) && (d[e] = b[e]);
            return d
        }, setAttributeConfig: function(c, b, d) {
            this._configs = this._configs || {};
            b = b || {};
            if (this._configs[c])
                this._configs[c].configure(b, d);
            else {
                b.name = c;
...
(function() {
    ...
    b.prototype = {DOM_EVENTS: null, DEFAULT_HTML_SETTER: function(b, a) {
        ...
        setStyle: function(b, a) {
            ...
            for (var b = this._queue, a = 0, c = b.length; a < c; ++a)
            ...
            for (var c = {}, e = this._configOrder, h = 0, i = e.length; h < i; ++h)
                if (b[e[h]] !== void 0) {
                    c[e[h]] = true;
                    this.set(e[h], b[e[h]], a)
                }
            for (var j in b)
                b.hasOwnProperty(j) && !c[j] && this.set(j, b[j], a)
        }, set: function(b, a, c) {
            ...
            for (var h in g)
                g.hasOwnProperty(h) && (this.DOM_EVENTS[h] = g[h]);
...
YAHOO.util.Color = function() {
    ...
    return{real2dec: function(b) {
            ...
            if (c(b))
                return this.hsv2rgb.call(this, b[0], b[1], b[2]);
            ...
            return[a(e), a(g), a(h)]
                ...
                d, a) {
            if (c(b))
                return this.rgb2hsv.apply(this, b);
            ...
            if (c(b))
                return this.rgb2hex.apply(this, b);
            var e = this.dec2hex;
            return e(b) + e(d) + e(a)
        }, dec2hex: function(b) {
            b = parseInt(b, 10) | 0;
        ...
        hex2dec: function(b) {
            ...
            if (c(b))
                return this.websafe.apply(this, b);
            var f = function(a) {
                if (e(a)) {
...
(function() {
    ...
    YAHOO.extend(c, YAHOO.util.Element, {ID: {R: "yui-picker-r", R_HEX: "yui-picker-rhex", G: "yui-picker-g", G_HEX: "yui-picker-ghex", B: "yui-picker-b", B_HEX: "yui-picker-bhex", H: "yui-picker-h",
        ...
        _createElements: function() {
            ...
            for (c in this.ID)
                d.hasOwnProperty(this.ID, c) && (b[this.ID[c]] = b[c]);
            (e = g.get(b[this.ID.PICKER_BG])) || this._createElements();
            for (c in b)
                if (d.hasOwnProperty(b, c)) {
                    e = g.get(b[c]);
                    f = g.generateId(e);
                    b[c] = f;
                    b[b[c]] = f;
            ...
            if (!a.ids && e > 1)
                for (h in b)
                    d.hasOwnProperty(b, h) && (b[h] = b[h] + e);
...
(function() {
    ...
    e.prototype = {toString: function() {
            ...
            if (a !== "auto" && !this.patterns.offsetUnit.test(a))
                return parseFloat(a);
            ...
            this._onTween.subscribe(function() {
                ...
                var b = this.runtimeAttributes,
                        c;
                for (c in b)
                    this.setAttribute(c, this.doMethod(c, b[c].start, b[c].end), b[c].unit);
                i = i + 1
            });
...
YAHOO.util.AnimMgr = new function() {
    ...
    this.run = function() {
        for (var b = 0, a = e.length; b < a; ++b) {
            var c = e[b];
            if (c && c.isAnimated())
                if (c.currentFrame < c.totalFrames || c.totalFrames === null) {
                    ...
                    YAHOO.util.AnimMgr.stop(c, b)
        }
    }
};
YAHOO.util.Bezier = new function() {
    this.getPosition = function(c, e) {
        for (var b = c.length, d = [], a = 0; a < b; ++a)
            d[a] = [c[a][0], c[a][1]];
        for (var f = 1; f < b; ++f)
            for (a = 0; a < b - f; ++a) {
...
(function() {
    ...
    d.parseColor = function(a) {
        ...
        if ((b = this.patterns.rgb.exec(a)) && b.length == 4)
    ...
    d.doMethod = function(a, c, d) {
        ...
        if (this.patterns.color.test(a)) {
            ...
            for (var i = 0, j = c.length; i < j; ++i)
                e[i] = b.doMethod.call(this, a, c[i], d[i]);
            e = "rgb(" + Math.floor(e[0]) + "," + Math.floor(e[1]) + "," + Math.floor(e[2]) + ")"
        } else
            e = b.doMethod.call(this, a, c, d);
        return e
    };
    d.setRuntimeAttribute = function(a) {
        ...
        if (this.patterns.color.test(a)) {
            ...
            if (typeof c[a].to === "undefined" && typeof c[a].by !== "undefined")
                for (var e = this.parseColor(c[a].by), c = 0, i = d.length; c < i; ++c)
                    e[c] = d[c] + e[c];
...
(function() {
    ...
    d.setAttribute = function(a, c, d) {
        if (this.patterns.points.test(a)) {
            ...
            b.setAttribute.call(this, a, c, d)
    };
    d.getAttribute = function(a) {
    ...
    d.setRuntimeAttribute = function(c) {
        if (this.patterns.points.test(c)) {
            ...
            b.setRuntimeAttribute.call(this, c)
    };
    var a = function(a, b) {
